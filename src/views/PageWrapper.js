const PageWrapper = (props) => {
    ...
    return (
        <div>
         <div id="preloader">
            <img className="logo" src="images/logo3.png" alt="" width="119" height="58"/>
            <div id="status">
                <span></span>
                <span></span>
            </div>
                    ...
                    <div className="collapse app" id="bs-example-navbar-collapse-1">
                        <ul className="nav navbar-nav flex-child-menu menu-left">
                            ...
                            <li className="dropdown first barranav">
                                <a href="/" className="btn btn-default dropdown-toggle lv1">Inicio</a>
                            </li>
                        ...
                        <ul className="nav navbar-nav flex-child-menu menu-right">
                            <li className="dropdown first barranav">
                                <a href="/login" className="btn btn-default dropdown-toggle lv1">Iniciar sesión</a>
                            </li>
        ...
        <div className="container">
            <div className="flex-parent-ft">
                <div className="flex-child-ft item1">
                     <a href="index-2.html"><img className="logo" src="images/logo3.png" alt=""/></a>
